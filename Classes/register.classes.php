...
class Register extends Dbh{
    ...
    protected function register($completeName,$email,$password,$userPhoto, $user,$telephone){
        //$stmt = $this->connect()->prepare('INSERT INTO USUARIO(nombreCompleto,email,contraseña,FotoUser,alias,diaregistro,telefono,activo,tipoU,StatusU,creadopor) VALUES(?,?,?,?,?,sysdate(),?,true,3,"A",117);');
     
        $stmt = $this->connect()->prepare('CALL sp_Usuario("b",null,?,?,?,?,?,?,3,"A",117,null,null);');
