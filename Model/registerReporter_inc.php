<?php
include "../Controller/registerReporter-contr.classes.php";
    if(isset($_POST["submit"])){
        ...
        if(!empty($userPhoto)){
            ...
            if(in_array($imageType,$allowedTypes)){
                ...
                header("location ../Views/RegisterReporter.php?error=no_valid_extension");
            }
    ...
    header("location: ../Views/RegisterReporter.php?error=none");
?>
